...
<form action="/staff/editStaff2.action" method="post">
    ...
    <table width="88%" border="0" class="emp_table" style="width:80%;">
            ...
            <td width="20%">
                <select onchange="onDeptSelected(value)" name="deptId">
                    <s:iterator value="departmentList" var="deptm">
                        <s:if test="#deptm.deptId==staffIdList.post.dept.deptId">
                            <option value="${deptm.deptId}"
        ...
        <tr>
            <td width="10%">入职时间：</td>
            <td width="20%">
                <input type="text" name="onDutyDate" value="${staffIdList.onDutyDate}" readonly="readonly"
